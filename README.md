...
The published site contains `Start Here.md`, `Open Questions.md`, `AI Context.md`, and the notes under `lore/`, `rules/`, and `tables/`. Project instructions, archives, resources, Obsidian settings, and trash are not copied into the website build.
