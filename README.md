...
The published site contains `Start Here.md`, `Open Questions.md`, and the notes under `lore/`, `rules/`, and `tables/`. AI context, project instructions, archives, resources, Obsidian settings, and trash are not copied into the website build.
